<x-layout>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <div class="flex items-center gap-3">
                    ...
                    {{-- Flight Number --}}
                    <h1 class="text-3xl md:text-4xl font-extrabold text-cyan-900 tracking-tight">
                        {{ $flight->flight_number }}
                    </h1>
                    
                    {{-- Airline --}}
                    <span class="text-sm text-cyan-700 font-medium bg-cyan-50 px-3 py-1 rounded-full border border-cyan-200 ml-2">
                    ...
                    <span class="px-3 py-1.5 rounded-full text-sm font-semibold ml-1
                        ...
                        {{ $flight['status'] === 'departed' ? 'bg-cyan-100 text-cyan-800 border border-cyan-200' : '' }}">
                        <i class="fa-regular 
            ...
            <div class="flex gap-3">
                <a href="#" class="bg-cyan-800 text-white px-3 py-2 rounded-xl hover:bg-cyan-600 transition flex items-center gap-2 shadow-sm hover:shadow-md">
    ...
    {{-- Flight Route Map --}}
    <div class="bg--to-br from-cyan-50 via-cyan-50/50 to-white rounded-2xl shadow-md p-8 mb-8 border border-cyan-100">
        <div class="flex items-center justify-between max-w-3xl mx-auto">
            {{-- Origin --}}
            <div class="text-center">
                <div class="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-2 shadow-sm border border-cyan-200">
                ...
                <p class="text-sm font-semibold text-cyan-700 mt-4 bg-cyan-80 px-3 py-1 rounded-full border border-cyan-200">
            ...
            <div class="flex-1 mx-6">
                <div class="relative">
                    {{-- Dashed line --}}
                    <div class="border-t-2 border-cyan-300 border-dashed"></div>
                    
                    {{-- Plane icon --}}
                    <div class="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-cyan-100 px-3 rounded-full border border-cyan-200">
                        <i class="fa-solid fa-plane text-cyan-900 text-lg"></i>
                    </div>
                    
                    {{-- Duration --}}
                    <p class="text-center text-xs text-cyan-600 mt-5">
                        <i class="fa-regular fa-clock mr-1"></i>
                        {{ $flight->duration }}
                    </p>
                </div>
            ...
            <div class="text-center">
                ...
                <p class="text-sm font-semibold text-cyan-700 mt-4 bg-cyan-50 px-3 py-1 rounded-full border border-cyan-200">
                    <i class="fa-regular fa-clock mr-1"></i>
                    {{ $flight->arrival_time }}
                </p>
            </div>
...
/>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl shadow-md p-6 border border-cyan-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-cyan-50/50 rounded-xl p-4 border border-cyan-100 col-span-1 md:col-span-2">
        ...
        <div>
            ...
            {{-- Additional Info --}}
            <div class="mt-4 bg-white rounded-2xl shadow-md p-6 border border-cyan-100">
                <h3 class="font-semibold text-cyan-800 text-sm uppercase tracking-wider mb-4 flex items-center gap-2">
    ...
    {{-- Passenger List --}}
    <div class="mt-8 bg-white rounded-2xl shadow-md border border-cyan-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-cyan-100 flex items-center justify-between bg-cyan-50/50">
            ...
            <button class="text-sm text-cyan-600 hover:text-cyan-800 font-medium transition bg-white px-4 py-1.5 rounded-lg border border-cyan-200 hover:bg-cyan-50">
                            ...
                            <tr class="border-b border-gray-50 hover:bg-cyan-50/30 transition">
                                <td class="px-6 py-3 font-medium text-gray-900">
                                    <div class="flex items-center gap-2">
                                        <div class="w-8 h-8 bg-cyan-100 rounded-full flex items-center justify-center text-cyan-700 text-xs font-bold border border-cyan-200">
        ...
        @else
            <div class="px-6 py-12 text-center text-cyan-300">
